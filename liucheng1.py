...
uri_index = '/'
# 实例化自己的Common
comm = Common('https://passport.baidu.com/v2/api/?login')
...
# uri_login存储战场的登录
uri_login = '.jhtml?spm=a21bo.jianhua.754894437.1.5af911d9BRch9e&f=top&redirectURL=https%3A%2F%2Fwww.taobao.com%2F'
# username变量存储用户名参数
username = 'criss'
# password变量存储密码参数
password = 'criss'
